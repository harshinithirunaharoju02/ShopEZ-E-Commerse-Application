      ...
      <div className="w-full max-w-md bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800/50 rounded-2xl shadow-xl p-8 transition-colors duration-300">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
            Register to start shopping and view orders
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex w-full justify-center items-center gap-2 rounded-xl bg-primary-600 px-4 py-3 text-sm font-semibold text-white shadow-md hover:bg-primary-700 hover:shadow-lg hover:shadow-primary-600/20 focus:outline-none disabled:opacity-50 transition-all duration-200 mt-6"
          >
            {loading ? (
